...
windres --codepage=1251 src\gui\app.rc -O coff -o src\gui\app.res
...
gcc -DGUI_BUILD -std=gnu99 -O2 ^
    ...
    src/instruction.c src/gui/app_core.c src/gui/html_report.c src/gui/map_view.c ^
    src/gui/about.c src/gui/gui_main.c src/gui/app.res ^
    -o RomesCov.exe ^
